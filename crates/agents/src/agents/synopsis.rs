...
impl Agent for SynopsisAgent {
    ...
    fn system_prompt(&self) -> &str {
        ...
        examination findings in 1-2 sentences), ASSESSMENT (primary diagnosis with ICD-9 code and key \
        ...
        drug interactions, abnormal vitals) prominently. You are a clinical decision support tool, not a \
