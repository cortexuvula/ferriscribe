...
- **Remaining copy-paste clusters** (2026-08-17 review) — RecordTab/GenerateTab patient-context state, ContextPanel/PatientContextSidebar parallel surfaces. oMLX note: it is not yet part of the office-sharing proxy layer (mDNS advertisement, pairing proxies) — only reachable locally or via direct LAN host entry.
