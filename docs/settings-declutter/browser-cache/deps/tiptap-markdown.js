...
import { C as Fragment, D as Schema, a as PluginKey, i as Plugin, w as Mark, x as DOMParser } from "./dist-D4JOGMZD.js";
import "./@tiptap_pm_state.js";
import { I as getHTMLFromFragment, a as Mark$1, et as index, o as Node$1, r as Extension } from "./dist-COfpNBQi.js";
...
function tokenHandlers(schema, tokens) {
	...
	for (let type in tokens) {
		...
		if (spec.block) {
			...
			if (noCloseToken(spec, type)) handlers[type] = noOp;
			else {
...
var Blockquote$1 = Node$1.create({ name: "blockquote" }).extend({ 
/**
...
var BulletList$1 = Node$1.create({ name: "bulletList" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var CodeBlock$1 = Node$1.create({ name: "codeBlock" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var HardBreak$1 = Node$1.create({ name: "hardBreak" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Heading$1 = Node$1.create({ name: "heading" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var HorizontalRule$1 = Node$1.create({ name: "horizontalRule" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Image$1 = Node$1.create({ name: "image" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var ListItem$1 = Node$1.create({ name: "listItem" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var OrderedList = Node$1.create({ name: "orderedList" });
...
var Paragraph$1 = Node$1.create({ name: "paragraph" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var Table$1 = Node$1.create({ name: "table" }).extend({ 
/**
* @return {{markdown: MarkdownNodeSpec}}
*/
addStorage() {
...
var markdownExtensions = [
	...
	Paragraph$1,
	Table$1,
	Node$1.create({ name: "taskItem" }).extend({ 
	/**
	* @return {{markdown: MarkdownNodeSpec}}
	*/
addStorage() {
	...
	Node$1.create({ name: "taskList" }).extend({ 
	/**
	* @return {{markdown: MarkdownNodeSpec}}
	*/
addStorage() {
	...
	Node$1.create({ name: "text" }).extend({ 
	/**
	* @return {{markdown: MarkdownNodeSpec}}
	*/
addStorage() {
